...
This folder holds the CEO agent's declarative configuration. It defines how the agent is instantiated and constrained at runtime, without embedding any of that behavior in code.
...
- Guardrails such as decision-scope limits and approval requirements.

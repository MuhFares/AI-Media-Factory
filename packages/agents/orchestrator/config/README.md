...
This folder holds the orchestrator agent's declarative configuration. It defines how the agent is instantiated and constrained at runtime, without embedding any of that behavior in code.
...
- Guardrails such as concurrency caps and retry policy limits.

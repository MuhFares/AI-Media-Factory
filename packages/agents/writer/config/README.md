...
This folder holds the writer agent's declarative configuration. It defines how the agent is instantiated and constrained at runtime, without embedding any of that behavior in code.
...
- Guardrails such as content-safety filters and brand-voice constraints.

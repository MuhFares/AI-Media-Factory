 ...
 */
export type ReviewArtifactKind = "coding_report" | "writer_report" | "seo_report" | "brand_report" | "thumbnail_report" | "video_report";

/** Review domain, derived from the artifact kind under review. */
export type ReviewMode = "coding" | "writer" | "seo" | "brand" | "thumbnail" | "video";
